...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "cryptography.hazmat.primitives.ciphers.algorithms", 107);
...
void checkModuleConstants_cryptography$hazmat$primitives$ciphers$algorithms(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "cryptography.hazmat.primitives.ciphers.algorithms", 107);
}
#endif
