...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "cryptography.hazmat.primitives._cipheralgorithm", 45);
...
void checkModuleConstants_cryptography$hazmat$primitives$_cipheralgorithm(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "cryptography.hazmat.primitives._cipheralgorithm", 45);
}
#endif
