...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "cryptography.hazmat.primitives.asymmetric.rsa", 267);
...
void checkModuleConstants_cryptography$hazmat$primitives$asymmetric$rsa(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "cryptography.hazmat.primitives.asymmetric.rsa", 267);
}
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_assign_source_52 = impl___main__$$$function__9__mro_entries_conversion(dir_call_args);
        }
