...
static PyObject *impl_urllib3$contrib$appengine$$$function__5__urlfetch_response_to_http_response(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_3:;
    {
...

        {
            ...
            tmp_assign_source_4 = impl___main__$$$function__13_complex_call_helper_keywords_star_dict(dir_call_args);
        }
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_33 = impl___main__$$$function__9__mro_entries_conversion(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_41 = impl___main__$$$function__9__mro_entries_conversion(dir_call_args);
        }
