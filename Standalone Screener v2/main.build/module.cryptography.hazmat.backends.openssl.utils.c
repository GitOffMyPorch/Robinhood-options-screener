...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "cryptography.hazmat.backends.openssl.utils", 62);
...
void checkModuleConstants_cryptography$hazmat$backends$openssl$utils(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "cryptography.hazmat.backends.openssl.utils", 62);
}
#endif
